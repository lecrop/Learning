...
[`Terminal_9-19-23.txt`](./Terminales Guardados/Terminal_9-19-23.txt)
:::
...
[`Terminal_9-20-23.txt`](./Terminales Guardados/Terminal_9-20-23.txt)
:::
...
```{r, echo=FALSE}
countData <- as.data.frame(read.csv('./Data/Basal_vs_Luminal_GC.csv', header = TRUE, row.names=1, sep = ","))
...
library(knitr)
kable(countData[1:6,], caption="./Data/Basal_vs_Luminal_GC.csv")
```
